...
namespace myEcommerceweb.Areas.Identity.Pages.Account.Manage
{
    ...
    {   
        ...
        public class InputModel
        {
            ...
            // i will add here the property for user information that user can edit it 
        ...
        private async Task LoadAsync(IdentityUser user)
        {
            ...
            var appUser = _unitOfWork.ApplicationUser.GetFirstOrDefault(x => x.Id == user.Id);
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (Input.Address != appUser.Address)
            {
